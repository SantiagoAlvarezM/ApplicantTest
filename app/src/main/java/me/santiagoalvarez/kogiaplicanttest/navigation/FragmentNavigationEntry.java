...
/**
 * This class defines a {@link Fragment} navigation transaction
 *
...
public class FragmentNavigationEntry extends NavigationEntry<Fragment> {
    ...
    private static final String TAG = "FragmentNavigationEntry";
    ...
    public static final Creator<FragmentNavigationEntry> CREATOR = new Creator<FragmentNavigationEntry>() {
        @Override
